...
This repository provides a suite of LaunchBar actions for accessing recent documents in Adobe applications. The actions are designed to streamline access to recent files, enhancing productivity for users working with Adobe Acrobat, Illustrator, and Photoshop. Each action is configured for quick retrieval and execution, integrating directly with LaunchBar for macOS.
